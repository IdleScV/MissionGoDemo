...
export const churches: SponsorshipOpportunity[] = [
  {
    ...
    description: 'Supporting local communities through education and healthcare initiatives.',
    goal: 25000,
    raised: 15000,
    imageUrl: 'https://images.unsplash.com/photo-1548515836-1c6127f5d228',
    mission: 'Bringing hope through education and healthcare to underserved communities.',
...
- Offering adult education and vocational training`,
    ...
    updates: [
      {
        ...
        content: 'Thanks to our generous donors, we have received new diagnostic equipment for our clinic.',
        imageUrl: 'https://images.unsplash.com/photo-1584515933487-779824d29309'
      },
      {
        date: '2024-02-28',
        title: 'Student Achievement Celebration',
        content: 'Our students achieved a 95% pass rate in their recent examinations.',
  ...
  },
  {
    ...
    description: 'Restoring historic church while serving urban poor communities.',
    goal: 50000,
    raised: 35000,
    imageUrl: 'https://images.unsplash.com/photo-1543339308-43e59d6b73a6',
    mission: 'Preserving heritage while serving the community through outreach programs.',
    ...
    updates: [
      {
        ...
        content: 'The first phase of our historic bell tower restoration project has commenced.',
        imageUrl: 'https://images.unsplash.com/photo-1548083085-b2346c18b451'
      },
      {
        date: '2024-02-15',
        title: 'Community Kitchen Milestone',
        content: 'Our soup kitchen has served its 50,000th meal to the community.',
        imageUrl: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b'
      }
    ],
    gallery: [
      'https://images.unsplash.com/photo-1543339308-43e59d6b73a6',
      'https://images.unsplash.com/photo-1548083085-b2346c18b451',
